...
! USAGE:
!
! CALL lslassoNET(lam2, nobs, nvars, x, y, jd, pf, pf2, dfmax, pmax, nlam, &
...
! ---------------------------------------------------------------------------- !
SUBROUTINE lslassoNET(lam2, nobs, nvars, x, y, jd, pf, pf2, dfmax, pmax, nlam,&
    ...
    CALL lslassoNETpath(lam2, maj, nobs, nvars, x, y, ju, pf, pf2, dfmax, pmax,&
