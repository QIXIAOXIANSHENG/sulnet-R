...
! ---------------------------------------------------------------------------- !
SUBROUTINE sunicoldstart(lam2, lamPos, nobs, nvars, x, y, jd, pf, pf2, dfmax, pmax, nlam,&
    ...
    CALL sunicoldstartNETpath(lam2, lamPos, maj, nobs, nvars, x, y, ju, pf, pf2, dfmax, pmax,&
    ...
    RETURN
END SUBROUTINE sunicoldstart

! ---------------------------------------------------------------------------- !
SUBROUTINE sunicoldstartNETpath(lam2, lamPos, maj, nobs, nvars, x, y, ju, pf, pf2, dfmax,&
    ...
    RETURN
END SUBROUTINE sunicoldstartNETpath
