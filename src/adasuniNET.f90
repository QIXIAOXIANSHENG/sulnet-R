...
! ---------------------------------------------------------------------------- !
SUBROUTINE adasuniNET(lam2, lamPos, nobs, nvars, x, y, jd, pf, pf2, dfmax, pmax, nlam,&
    ...
    CALL adasuniNETNETpath(lam2, lamPos, maj, nobs, nvars, x, y, ju, pf, pf2, dfmax, pmax,&
    ...
    RETURN
END SUBROUTINE adasuniNET

! ---------------------------------------------------------------------------- !
SUBROUTINE adasuniNETNETpath(lam2, lamPos, maj, nobs, nvars, x, y, ju, pf, pf2, dfmax,&
    ...
    RETURN
END SUBROUTINE adasuniNETNETpath
