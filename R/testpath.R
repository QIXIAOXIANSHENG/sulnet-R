...
testpath <- function(x, y, nlam, flmin, ulam, isd, intr, eps, dfmax, pmax, jd, pf,
  ...
  if(negOnly){
    fit <- .Fortran("soft_unilassoNET", lam2,lamPos, nobs, nvars, x, as.double(y), jd, pf, pf2,
