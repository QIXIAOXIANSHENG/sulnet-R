#' Get coefficients or make coefficient predictions from a "sulnet" object.
#'
...
#' \code{lambda} indices.
#'
#' @aliases coef.sulnet coef.hsvmpath coef.sqsvmpath coef.logitpath coef.lspath
#'   coef.erpath
...
#'
#' @seealso \code{\link{predict.sulnet}} method
#'
...
#' coef(cv1, type = "coef")
#' coef(cv1, type = "nonzero")
#'
#' @export
coef.sulnet <- function(object, s = NULL,
...
##'
##' @seealso \code{\link{coef.sulnet}}, \code{\link{coef.erpath}},
